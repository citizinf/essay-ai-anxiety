...
**In general, hoping the AI revolution will follow the path of past revolutions is utterly complacent - the labor disruptions of the past were side effects. The main driver of job creation in new and expanding sectors was the nature of the technology itself: ag and IR magnifying physical output from a given physical input, reshaping our environment and its constraints (e.g. ag leading to military development because fields can't just be picked up and moved when an invasion happens); information rev "creating" a whole new digital/cyberspace realm and dropping comms latency substantially. Main fear/risk with AI is that it can be broadly applied to all white-collar work, a huge category, _just_ as labor substitute, without any physical environment changes that create new jobs. Job replacement is more direct, takes less time/innovation, and incentivized; advances in robotics/manufacturing/etc. which may make new jobs of the future beyond AI supervision, like space tourism/maintenance, are slower, as I mentioned previously. (A quick way to put it: AI revolution much also spawn robotics revolution, nanotech revolution, manufacturing revolution, etc. in order to create new sectors; if it remains just an AI revolution then pressure on old jobs will far outweigh the creation of new ones.)**
